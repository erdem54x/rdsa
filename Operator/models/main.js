...
menu.reply.edit(isimgeçmişiEmbed)
  ...
  Stat.findOne({
      ...
      }).map((x, index) => `${client.emojis.cache.find(x => x.name === "ravgar_circle")} ${menu.guild.channels.cache.get(x) ? menu.guild.channels.cache.get(x).name : "#kanal-bulunamadı"} \`${client.convertDuration(data.voiceCategory[x])}\``).join("\n");
      ...
      }).map((x, index) => `${client.emojis.cache.find(x => x.name === "ravgar_circle")} #${menu.guild.channels.cache.get(x) ? menu.guild.channels.cache.get(x).name : "#kanal-bulunamadı"} \`${client.convertDuration(data.voiceChannel[x])}\``).join("\n");
      ...
      }).map((x, index) => `${client.emojis.cache.find(x => x.name === "ravgar_circle")} #${menu.guild.channels.cache.get(x) ? menu.guild.channels.cache.get(x).name : "#kanal-bulunamadı"} \`${data.messageChannel[x]} mesaj\``).join("\n");
...
${client.emojis.cache.find(x => x.name === "ravgar_circle")} Toplam Kayıt: \`${teyit} kişi\`
${client.emojis.cache.find(x => x.name === "ravgar_circle")} Toplam Davet: \`${invite} kişi\`
${client.emojis.cache.find(x => x.name === "ravgar_circle")} Toplam Taglı: \`${taglı} kişi\`
${client.emojis.cache.find(x => x.name === "ravgar_circle")} Toplam Yetkili: \`${yetkili} kişi\`
`)
