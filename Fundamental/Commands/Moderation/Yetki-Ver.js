...
module.exports.run = async (client, message, args, durum, kanal) => {
    ...
    \`.yetkili @ravgar/id 1\` - ${baslangıcYt}
    \`.yetkili @ravgar/id 2\` - ${ikinciYt}
    \`.yetkili @ravgar/id 3\` - ${ücüncüYe}
...
\`.yetkili @ravgar/id 3\` - ${ücüncüYe}
    ...
    client.channels.cache.find(a => a.name === "yetki-log").send(`:small_orange_diamond: ${member} (\`${member.id}\`) adlı üyeye başlangıç yetkileri verildi. [\`${moment(Date.now()).locale("tr").format("LLL")}\`]${message.guild.roles.cache.get(ucuncuYT) ? message.guild.roles.cache.get(ucuncuYT).name : ucuncuYT }`).catch(() => { });
  ...
  if(args[1] === "2") {
    member.roles.add(Server.ikinciyetkiler)
      ...
      client.channels.cache.find(a => a.name === "yetki-log").send(`:small_orange_diamond: ${member} (\`${member.id}\`) adlı üyeye 2. yetki permleri verildi. [\`${moment(Date.now()).locale("tr").format("LLL")}\`]${message.guild.roles.cache.get(ucuncuYT) ? message.guild.roles.cache.get(ucuncuYT).name : ucuncuYT }`).catch(() => { });
    ...
    if(args[1] === "3") {
      ...
      client.channels.cache.find(a => a.name === "yetki-log").send(`:small_orange_diamond: ${member} (\`${member.id}\`) adlı üyeye 3. yetki permleri verildi. [\`${moment(Date.now()).locale("tr").format("LLL")}\`]${message.guild.roles.cache.get(ucuncuYT) ? message.guild.roles.cache.get(ucuncuYT).name : ucuncuYT }`).catch(() => { });
